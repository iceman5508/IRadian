...
@version .9 Beta
 * <br>
 *The original router class. However as of version 1.0 Beta
 * This class is being replaced by the iAppRoute class in the
 * IRadian package. Currently this is the secondary router class.
 * iAppRoute is not the primary router class.
 *
 **/
...
class iRouter
{
    ...
    /**
     * List of all params associated with the route
     * @var null
     */
     ...
     * @param iComponent $component - The component to load if the route is given
     */
    ...
    /**
     * Set a router link
     * @param $linkName - The location to return
     * @return string
     */
     ...
     * @param $limit - The limit of slashes to have in the url
